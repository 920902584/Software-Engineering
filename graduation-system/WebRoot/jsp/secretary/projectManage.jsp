...
<li><a class="hide" href="/graduation-system2.1/jsp/secretary/Main.jsp">返回首页</a></li>
    ...
    <div class="main">
    	<div class="main-top">当前位置--论文信息管理：</div>
        <div class="main-show">
        	<br/>
            <label for="find" style="margin-left:50px">论文号查询 </label><input type="text" name="stufind" placeholder="请输入论文号"/>   <input type="submit" id="find" value="查询"/>
        	<br/><br/>
        	<table border="0" align="center" cellpadding="0" cellspacing="0" ><!--  style="border-collapse:separate; border-spacing:0px 10px;"> -->
            	<tr><td style="border:2px solid #A9BAFC" width="20px" align="center"></td>
                    ...
                    <td style="border:2px solid #A9BAFC" width="150px" align="center">论文编号</td>
                    <td style="border:2px solid #A9BAFC" width="300px" align="center">论文题目</td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center">发布时间</td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center">选择该题目学生号</td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center">学生姓名</td></tr>
                    
                    <%
                    	ProjectDAOImpl teacherDao = new ProjectDAOImpl();
						List<Project> projects = teacherDao.findAllProject();
						int teaTotal=1;
						if(projects!=null&&projects.size()>0)
						{
				   				for(int i=0;i<projects.size();i++)
				 		  		{
				   					...
				   					Teacher tea = new TeacherDAOImpl().findTeacherById(pro.getTeacherId());
				   					if(pro.getStudentId()!=null){
				   						Student stu = new StudentDAOImpl().findStudentById(pro.getStudentId());
                    %>
                <tr>
                	<td style="border:2px solid #A9BAFC" width="20px" align="center"><%=teaTotal %></td>
                	<td style="border:2px solid #A9BAFC" width="150px" align="center"><%=pro.getTeacherId() %></td>
                	<td style="border:2px solid #A9BAFC" width="150px" align="center"><%=tea.getName() %></td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center"><%=pro.getProjectId() %></td>
                    <td style="border:2px solid #A9BAFC" width="300px" align="center"><%=pro.getProName() %></td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center"><%=pro.getCreateTime() %></td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center"><%=pro.getStudentId() %></td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center"><%=stu.getName() %></td></tr>
                    <%}
                    	else{
                    	%>
                    	<tr>
                    ...
                    <td style="border:2px solid #A9BAFC" width="150px" align="center"></td></tr>
                 <%
                    	}
                 teaTotal++;
                    		}
