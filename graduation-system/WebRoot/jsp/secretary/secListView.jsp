...
<%@page import="com.system.daoImpl.SecretaryDAOImpl"%>
<%@page import="com.system.dao.StudentDAO"%>
<%@page import="com.system.bean.Student"%>
<%@page import="com.system.bean.Secretary"%>
...
<li><a class="hide" href="/graduation-system2.1/jsp/secretary/Main.jsp">返回首页</a></li>
    ...
    <div class="main">
    	<div class="main-top">当前位置--管理员信息管理：</div>
        <div class="main-show">
        	<br/>
            <label for="find" style="margin-left:50px">管理员号查询 </label><input type="text" name="stufind" placeholder="请输入管理员号"/>   <input type="submit" id="find" value="查询"/>
        	<br/><br/>
        	<table border="0" align="center" cellpadding="0" cellspacing="0" ><!--  style="border-collapse:separate; border-spacing:0px 10px;"> -->
            	<tr><td style="border:2px solid #A9BAFC" width="150px" align="center"></td>
            		<td style="border:2px solid #A9BAFC" width="150px" align="center">管理员号</td>
                    ...
                    <%
                    	SecretaryDAOImpl secretaryDao = new SecretaryDAOImpl();
						List<Secretary> secretarys = secretaryDao.findAllSecretary();
						int teaTotal=1;
						if(secretarys!=null&&secretarys.size()>0)
						{
				   				for(int i=0;i<secretarys.size();i++)
				 		  		{
				   					Secretary sec = secretarys.get(i);
                    %>
                <tr>
                	<td style="border:2px solid #A9BAFC" width="150px" align="center"><%=teaTotal %></td>
                	<td style="border:2px solid #A9BAFC" width="150px" align="center"><%=sec.getSecretaryId() %></td>
                	<td style="border:2px solid #A9BAFC" width="150px" align="center"><%=sec.getName()%></td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center"><%=sec.getTelephone() %></td>
                    <td style="border:2px solid #A9BAFC" width="150px" align="center"><%=sec.getMailbox() %></td>
