...
public class StudentselectionInsert extends HttpServlet {
 ...
 */
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ((LLocalTime < LStartTime) || (LLocalTime > LEndTime)) {
			...
			sele.addStudentselection(studentId, teacherId);

			dispatcher = servletContext
					.getRequestDispatcher("/jsp/student/student_decide.jsp");// 设置跳转页面
		}
